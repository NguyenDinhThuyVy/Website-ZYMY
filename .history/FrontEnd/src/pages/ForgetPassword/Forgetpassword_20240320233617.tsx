...
import forgetPassword from 'src/apis/user.api' // Đảm bảo import hàm forgetPassword từ module API
...
export default function Forgetpassword() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      await forgetPassword({ email: data.email }) // Gọi hàm forgetPassword với email nhận được từ form
