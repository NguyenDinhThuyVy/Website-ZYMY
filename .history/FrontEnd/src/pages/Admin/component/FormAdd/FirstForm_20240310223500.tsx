...
import { Button, Form, Input, Modal, ConfigProvider, DatePicker, Select, InputNumber, type FormInstance } from 'antd'
...
const CollectionCreateForm: React.FC<CollectionCreateFormProps> = ({ onFormInstanceReady }) => {
  ...
  return (
    <Form
      ...
      variant='filled'
      form={form}
      className='grid grid-rows-4 grid-flow-col gap-2 w-full p-5 '
