...
import { Button, Form, Input, Modal, Radio, type FormInstance, ConfigProvider } from 'antd'
    ...
    <>
      <ConfigProvider
        theme={{
          components: {
            Button: {
              defaultHoverColor: '#fadede'
            }
          }
        }}
      >
        {' '}
        <Button type='primary' onClick={() => setOpen(true)} className='bg-red-200 w-28'>
          New Collection
        </Button>
      </ConfigProvider>
