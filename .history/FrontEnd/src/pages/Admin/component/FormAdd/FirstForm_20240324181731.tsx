    ...
    try {
      ...
      Object.entries(values).forEach(([key, value]) => {
        if (key === 'images' && Array.isArray(value)) {
          // Chuyển mỗi URL thành một chuỗi và nối chúng thành một chuỗi duy nhất, cách nhau bởi dấu phẩy
          const imagesString = value.join(',')
          formData.append(key, imagesString)
        } else {
