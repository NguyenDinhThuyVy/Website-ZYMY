    ...
    <div className='pt-[5px]'>
      <form className='px-[20px]' onSubmit={handleSubmit(hanlderFirstForm)}>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-[20px]'>
          ...
          <Field>
            <div className='mb-2'>
              <label htmlFor={dd} className='text-xl font-semibold cursor-pointer'>
                hihi
              </label>
            </div>
            <Input
        ...
        <div className='grid grid-cols-1 mb:grid-cols-2 md:grid-cols-4 gap-x-[20px]'>
          ...
          <div className='flex flex-col items-start w-full'>
            ...
            <Input type='number' name='price' id='price' placeholder='Enter price' className='border' />
          ...
          <div className='flex flex-col items-start w-full'>
            ...
            <Input type='number' name='quantity' id='quantity' placeholder='Enter quantity' className='border' />
            <p className='font-semibold text-xs text-red-700 h-[20px] py-1'>
