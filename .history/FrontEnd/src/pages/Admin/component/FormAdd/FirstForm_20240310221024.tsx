...
const CollectionCreateForm: React.FC<CollectionCreateFormProps> = ({ onFormInstanceReady }) => {
  ...
  return (
    <Form
      ...
      variant='filled'
      // style={{ width: '1000px' }}/
      className='grid grid-rows-4 grid-flow-col gap-4 w-full p-5 '
    >
...
const CollectionCreateFormModal: React.FC<CollectionCreateFormModalProps> = ({ open, onCreate, onCancel }) => {
...
const FristForm: React.FC = () => {
  ...
  return (
    <>
      ...
      <CollectionCreateFormModal open={open} onCreate={onCreate} onCancel={() => setOpen(false)} />
    </>
  )
}
