...
const Uploadimgs: React.FC<UploadimgsProps> = ({ onUpload }) => {
  ...
  const onChange: UploadProps['onChange'] = async ({ fileList: newFileList }) => {
    ...
    const uploadedImages: string[] = uploadRes.data.data.map((image: string) => image.name) // Lấy tên của từng hình ảnh từ dữ liệu phản hồi
    uploadedDataArray.push(...uploadedImages) // Thêm tên các hình ảnh vào mảng uploadedDataArray
