...
function TableData() {
  ...
  const columns: TableProps<Product>['columns'] = [
...

    {
      ...
      key: 'category.name',
      filters: [{ text: 'category.name', value: 'category.name' }],
      filteredValue: filteredInfo.category.name,
      onFilter: (value: string, record) => record['category']['name'].includes(value),
      sorter: (a, b) => a.category.name.localeCompare(b.category.name), // Assuming alphabetical sorting
      sortOrder: sortedInfo.columnKey === 'category.name' ? sortedInfo.order : null,
      ellipsis: true
    },
