...
const FormProductEdit: React.FC<CollectionCreateFormProps> = ({ productId, onClose, onUpdateSuccess }) => {
  ...
  const updateImagesArray = (images: string[], indexToRemove: number): string[] => {
            ...
            <Upload
              ...
              onRemove={() => {
                ...
                setProductData((prevProductData) => ({
                  ...
                  data: {
                    ...prevProductData.data,
                    images: updateImagesArray(prevProductData.data.data.images, indexToRemove)
                  }
                }))
              }}
