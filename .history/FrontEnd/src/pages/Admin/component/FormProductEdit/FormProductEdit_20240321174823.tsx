...
const FormProductEdit: React.FC<CollectionCreateFormProps> = ({ productId, onClose, onUpdateSuccess }) => {
  ...
  const [productData1, setProductData1] = useState<any>(null)
  ...
  const images = productData1?.data.images
  const initialFileList = images ? convertUrlsToFileList(productData1?.data.images) : []
  return (
    <Modal
      open
      width={1200}
          ...
          <Form.Item label='Ảnh chính' name='image' initialValue={image}>
            <Upload
              ...
              onRemove={() => {
                ...
                setProductData1((prevProductData) => ({
                  ...prevProductData,
                  data: {
                    ...prevProductData.data,
                    images: []
