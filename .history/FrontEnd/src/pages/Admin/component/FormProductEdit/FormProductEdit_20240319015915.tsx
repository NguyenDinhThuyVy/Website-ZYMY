        ...
        <div className='grid grid-cols-2 grid-flow-row  w-full'>
          <Form.Item label='Ảnh chính' name='image' initialValue={image}>
            <Upload
              ...
              onRemove={() => {
                // Replace the image with another URL when the remove button is clicked
                // Replace 'https://example.com/another-image.jpg' with your desired URL
                form.setFieldsValue({ image: 'https://example.com/another-image.jpg' })
              }}
              onChange={(info) => {
