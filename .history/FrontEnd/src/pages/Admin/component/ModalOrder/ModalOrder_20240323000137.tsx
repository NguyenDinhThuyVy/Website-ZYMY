...
const ModalOrder: React.FC<Props> = ({ orderdata, visible, onClose, orderId }) => {
  ...
  return (
    <Modal title={`Chi tiết đơn hàng: `} open={visible} onCancel={onClose} footer={null} width={1200}>
      {orderDetail && (
        <table className='table-auto w-full'>
          ...
          <tbody>
            <tr>
              ...
              <td className='px-4 py-2'>{orderDetail.product.price * orderDetail.buy_count}</td>
