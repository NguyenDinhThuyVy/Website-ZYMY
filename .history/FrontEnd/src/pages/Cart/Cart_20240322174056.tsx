...
export default function Cart() {
  ...
  const buyProductsMutation = useMutation({
    ...
    onSuccess: (data) => {
      setDataAddress(data.data.data.id)
      if (shouldRefetch) {
        refetch()
          ...
          <>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
              ...
              <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
                ...
                <Modal title='Nhập địa chỉ thanh toán' open={isModalVisible} onCancel={handleCancel} footer={null}>
                  <Payment onUpdateSuccess={handleUpdateSuccess} /> {/* Thay thế bằng nội dung modal của bạn */}
                </Modal>
              </div>
            </div>
          </>
