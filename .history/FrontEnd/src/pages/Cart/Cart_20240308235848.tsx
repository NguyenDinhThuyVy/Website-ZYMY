...
export default function Cart() {
  ...
  return (
    <div className='container mb-20 bg-neutral-100'>
      <div className='bg-white py-16  shadow mx-32 p-5'>
        <div className='overflow-auto '>
          <div className='min-w-[1000px] '>
            ...
            {extendedPurchases.length > 0 && (
              <div className='my-3 rounded-sm bg-neutral-100 p-5 shadow'>
                {extendedPurchases?.map((purchase, index) => (
                  <div
                    key={purchase._id}
                    className='mb-5 grid grid-cols-12 rounded-sm border border-gray-200 bg-neutral-100 py-5 px-4 text-center text-sm text-gray-500 first:mt-0'
                  >
                    <div className='col-span-6'>
                      <div className='flex'>
                        <div className='flex flex-shrink-0 items-center justify-center pr-3'>
        ...
        <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
          ...
          <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
            ...
            <Button
              className='mt-5 flex h-10 w-52 items-center justify-center bg-gradient-to-b from-yellow to-rose-400 text-sm uppercase text-white hover:opacity-90 sm:ml-4 sm:mt-0'
