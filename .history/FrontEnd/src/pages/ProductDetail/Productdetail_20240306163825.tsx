...
const content2 = (
  <div>
    <p>Nhận lại gấp đôi số tiền mà bạn đã thanh toán cho sản phẩm không chính hãng từ Shopee Mall</p>
  </div>
)
const content2 = (
  <div>
    <p>Ưu đãi miễn phí vận chuyển lên tới 40,000 VNĐ cho đơn hàng của Shopee Mall từ 150,000 VNĐ</p>
  </div>
)
