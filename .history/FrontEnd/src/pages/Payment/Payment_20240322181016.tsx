    ...
    <div>
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 m-5'>
        <div className=' flex gap-3 items-center'>
          ...
          <Input value={address.street} onChange={handleChange} required name='street' className='w-[380px]' />
        </div>
        ...
        <div className=' flex gap-2 items-center'>
          ...
          <Input id='phone' value={address.phone} onChange={handleChange} required name='phone' className='w-[380px]' />
        </div>
        <div className=' flex gap-2 items-center'>
