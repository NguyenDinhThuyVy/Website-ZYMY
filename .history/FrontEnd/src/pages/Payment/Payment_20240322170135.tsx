    ...
    <div>
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 m-5'>
        <div className=' flex gap-3 items-center'>
          ...
          <Input value={address.city} onChange={handleChange} required id='street' />
        </div>
        <div className=' flex gap-5 items-center'>
          <label htmlFor='city' className='text-sm'>
            City :
          </label>
          <Input value={address.city} onChange={handleChange} className='w-[378px]' required id='city' />
        </div>
        <div className=' flex gap-4 items-center'>
          <label htmlFor='postalCode'>Code:</label>
          <Input value={address.postalCode} onChange={handleChange} className='w-[380px]' required id='postalCode' />
        </div>
        <div className=' flex gap-2 items-center'>
          <label htmlFor='phone'>Phone:</label>
          <Input id='phone' value={address.phone} onChange={handleChange} required />
        </div>
        <div>
        ...
        <button type='submit' className='border-solid border-2 border-red-400 w-[80px] mr-0 bg-red-400 rounded-md'>
          Complete
        </button>
      </form>
    </div>
