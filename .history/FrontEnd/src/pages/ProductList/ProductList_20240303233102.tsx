  ...
  return (
    <div className='bg-[#f5f5f5ff] h-full flex flex-col '>
      ...
      <div className='min-h-80 bg-slate-50 my-10 mx-32 '>
        <div className='py-7 px-5 flex justify-between border-b-2 border-gray-100'>
          ...
          <div className='flex flex-row gap-1 text-gray-400 items-center hover:text-gray-300 mt-2'>
            <Link to='/'>Xem thêm</Link>
            <BsChevronRight />
          </div>
        </div>

        <div className='flex flex-row gap-5 items-center justify-center px-1 '>
          <div className='flex h-52 w-full items-start'>
            <ItemTop></ItemTop>
          </div>
        </div>
      </div>
