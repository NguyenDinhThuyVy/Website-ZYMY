...
export default function ProductList() {
  return (
    <div className='bg-[#f5f5f5ff] h-full flex flex-col '>
      ...
      <div className='flex items-center w-full justify-center my-10 mx-32'>
        <div>
          <img src='https://cf.shopee.vn/file/sg-50009109-ed7001d4fdaf4b372263eacb5e3ace9a' alt='' className='roud' />
        </div>
      </div>
    </div>
  )
