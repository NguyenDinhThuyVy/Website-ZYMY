    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              ' bg-gradient-to-b from-yellow to-rose-400 hover:bg-orange/80': isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              ' bg-gradient-to-b from-yellow to-rose-400': isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames('h-8  px-4 text-left text-sm capitalize  outline-none ', {
              ' bg-gradient-to-b from-yellow to-rose-400': isActiveSortBy(sortBy.price),
