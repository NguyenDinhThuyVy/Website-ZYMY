  ...
  return (
    <div className='bg-[#f5f5f5ff] h-full flex flex-col '>
      ...
      <div className='min-h-80 bg-slate-50 my-10 mx-32 '>
        ...
        {productsData && (
          <div className='flex flex-row gap-5 items-center justify-center px-1 mt-2 min-h-96 '>
            <div className='flex h-80 w-full items-start'>
              <ItemTop data={productsData}></ItemTop>
            </div>
          </div>
        )}
      </div>
      <div className='flex bg-slate-50  mx-32 p-5 uppercase text-rose-500 font-bold border-b-4 border-rose-400 items-center justify-center'>
        Gợi Ý Hôm Nay
      </div>
