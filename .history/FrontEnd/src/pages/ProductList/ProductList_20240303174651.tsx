    ...
    <div className='bg-[#f5f5f5ff] h-full flex flex-col gap-3'>
      ...
      <div className='bg-slate-50  my-10 mx-32'>
        ...
        <div className=' grid grid-cols-8 py-5 '>
          <ItemCategory img='aonam.png' name='Áo Nam'></ItemCategory>
          <ItemCategory img='dienthoai.png' name='Điện Thoại'></ItemCategory>
          <ItemCategory img='dientu.png' name='Đồ Điện Tử'></ItemCategory>
          <ItemCategory img='latop.png' name='Laptop'></ItemCategory>
          <ItemCategory img='aonu.png' name='Áo Nữ'></ItemCategory>
          <ItemCategory img='giay.png' name='Giày'></ItemCategory>
          <ItemCategory img='tuixach.png' name='Túi Xách'></ItemCategory>
          <ItemCategory img='aonam.png' name='Áo Nam'></ItemCategory>
        </div>
      </div>
    </div>
