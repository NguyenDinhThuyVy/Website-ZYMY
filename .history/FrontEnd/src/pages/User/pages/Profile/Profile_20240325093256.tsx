...
export default function Profile() {
  ...
  return (
    <div className='rounded-sm bg-white px-1 pb-10 shadow md:px-7 md:pb-20'>
        ...
        <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
          <div className='flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <div className='w-full bg-gray-100 rounded-sm border border-gray-300 px-3 py-2 outline-none'>
                {profile?.email}
              </div>
            </div>
          </div>
          ...
          <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
            ...
            <div className='sm:w-[80%] sm:pl-5'>
              <Button
                className='flex h-9 items-center rounded-sm bg-rose-400 px-5 text-center text-sm text-white hover:bg-rose-400/80'
                type='submit'
              >
                Lưu
              </Button>
