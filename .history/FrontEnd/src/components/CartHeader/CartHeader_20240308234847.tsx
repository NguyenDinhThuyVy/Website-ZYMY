...
export default function CartHeader() {
  ...
  return (
    <div className='border-b border-b-black/10'>
      <div className=' bg-gradient-to-b from-yellow to-yellow text-white'>
        <div className='container'>
          <NavHeader />
        </div>
      </div>
      <div className=' bg-gradient-to-b from-yellow to-rose-400 text-white py-6'>
        <div className='container'>
          <nav className='md:flex md:items-center md:justify-between'>
            <Link to={path.home} className='col-span-2 ml-3 flex item-center'>
            ...
            <form className='mt-3 md:mt-0 md:w-[50%]' onSubmit={onSubmitSearch}>
              <div className='flex rounded-sm border-2 border-rose-500'>
                <input
                  type='text'
