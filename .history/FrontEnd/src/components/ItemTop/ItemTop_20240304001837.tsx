...
const ItemTop: FC<AppProps> = () => {
  return (
    ...
    >
      <SwiperSlide className=' flex flex-col items-center border justify-center px-2 py-4 shadow-none hover:shadow-lg w-full relative '>
        <Link to='/' className='flex flex-col gap-5 items-center pb-4 '>
