...
const ItemTop: FC<AppProps> = () => {
  return (
    ...
    >
      <SwiperSlide className=' flex flex-col items-center border justify-center px-2 py-3 shadow-none hover:shadow-lg w-full relative '>
        ...
        <div className='absolute bottom-0 w-full'>
          <div className=' bg-gradient-to-b from-yellow to-rose-400 text-white  w-full h-7 flex items-center justify-center rounded-br-lg'>
            TOP
          </div>
        </div>
      </SwiperSlide>
